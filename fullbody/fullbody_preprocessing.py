    ...
    for video in videos:
        ...
        while check:
            ...
            if img is not None:
                ...
                cv2.imwrite(
                    savePathActorImg + "/%s_%d_%s.png" % ("A", imageNumber, video[:-4]),
                    imageActor,
                )
                ...
                cv2.imwrite(
                    savePathSubjectImg
                    + "/%s_%d_%s.png" % ("S", imageNumber, video[:-4]),
                    imageSubject,
                )
        ...
        if not os.path.exists(savePathActorImg):
            ...
            while check:
                ...
                if img is not None:
                    ...
                    cv2.imwrite(
                        savePathActorImg + "/%d.png" % imageNumber, imageActor * 255
                    )
                    # except:
                    # print("------error1!")
                    ...
                    cv2.imwrite(
                        savePathSubjectImg + "/%d.png" % imageNumber, imageSubject * 255
                    )
